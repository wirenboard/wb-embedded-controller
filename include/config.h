 ...
 *    канал V33_STARTUP покрывает диапазон 3.0 - 3.3 В и нужен для
 *    проверки наличия 3.3В при старте прошивки, т.к. это может произойти в любой момент
 */
#define VOLTAGE_MONITOR_DESC(m) \
    ...
    m(V33_STARTUP,      ADC_3V3,            2900,   3400,       2800,   3500  ) \
